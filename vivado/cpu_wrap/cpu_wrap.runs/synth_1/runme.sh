...
HD_PWD='/home/yutong/RISC-V_SoC/vivado/cpu_wrap/cpu_wrap.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_wrap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_wrap.tcl
