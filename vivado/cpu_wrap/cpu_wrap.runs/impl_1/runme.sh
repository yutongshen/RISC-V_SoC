...
HD_PWD='/home/yutong/RISC-V_SoC/vivado/cpu_wrap/cpu_wrap.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_wrap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_wrap.tcl -notrace
