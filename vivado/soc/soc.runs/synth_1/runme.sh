...
HD_PWD='/home/yutong/RISC-V_SoC/vivado/soc/soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_wrapper.tcl
