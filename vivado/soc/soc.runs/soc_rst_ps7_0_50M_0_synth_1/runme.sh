...
HD_PWD='/home/yutong/RISC-V_SoC/vivado/soc/soc.runs/soc_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_rst_ps7_0_50M_0.tcl
