...
HD_PWD='/home/yutong/RISC-V_SoC/vivado/soc/soc.runs/soc_axi_apb_bridge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_axi_apb_bridge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_axi_apb_bridge_0_0.tcl
