...
always_comb begin
    ...
    for (i = 0; i < 2; i = i + 1) begin
        ...
        m_awid    [  0+:  1] = m_awid[  0+:  1] | ({  1{s_awsel[i]}} &            i );
        m_awid    [  1+: 10] = m_awid[  1+: 10] | ({ 10{s_awsel[i]}} & s_awid    [i]);
    ...
    for (i = 0; i < 2; i = i + 1) begin
        ...
        m_wid     [  0+:  1] = m_wid [  0+:  1] | ({  1{s_wsel[i]}} &            i );
        m_wid     [  1+: 10] = m_wid [  1+: 10] | ({ 10{s_wsel[i]}} & s_wid     [i]);
    ...
    for (i = 0; i < 2; i = i + 1) begin
        ...
        m_arid    [  0+:  1] = m_arid[  0+:  1] | ({  1{s_arsel[i]}} &            i );
        m_arid    [  1+: 10] = m_arid[  1+: 10] | ({ 10{s_arsel[i]}} & s_arid    [i]);
