...
echo "        for (j = 1; j < SLV_NUM; j = j + 1) begin"                       >> ${fname};
echo "            for (k = 1; k < SLV_NUM; k = k + 1) begin"                   >> ${fname};
echo "                ar_grant_matrix[i][(i + j) % SLV_NUM] =  ar_grant_matrix[i][(i + j) % SLV_NUM] &" >> ${fname};
echo "                                                         ~s_arvalid[(i + k) % SLV_NUM];" >> ${fname};
echo "            end"                                                         >> ${fname};
echo "        end"                                                             >> ${fname};
echo "    end"                                                                 >> ${fname};
echo "end"                                                                     >> ${fname};
...
echo "        for (j = 1; j < SLV_NUM; j = j + 1) begin"                       >> ${fname};
echo "            for (k = 1; k < SLV_NUM; k = k + 1) begin"                   >> ${fname};
echo "                aw_grant_matrix[i][(i + j) % SLV_NUM] =  aw_grant_matrix[i][(i + j) % SLV_NUM] &" >> ${fname};
echo "                                                         ~s_awvalid[(i + k) % SLV_NUM];" >> ${fname};
echo "            end"                                                         >> ${fname};
echo "        end"                                                             >> ${fname};
echo "    end"                                                                 >> ${fname};
echo "end"                                                                     >> ${fname};
